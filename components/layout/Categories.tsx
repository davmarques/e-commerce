const categories = [
  { name: "Masculino", slug: "masculino", gridClass: "md:col-span-2 md:row-span-2", bg: "bg-neutral-100" },
  { name: "Acessórios", slug: "acessorios", gridClass: "md:col-span-1 md:row-span-1", bg: "bg-neutral-200" },
  { name: "Calçados", slug: "calcados", gridClass: "md:col-span-1 md:row-span-2", bg: "bg-neutral-300" },
  { name: "Feminino", slug: "feminino", gridClass: "md:col-span-1 md:row-span-1", bg: "bg-neutral-100" },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-[600px] md:h-[700px]">
        {categories.map((cat) => (
          <a
            ...
            className={`group relative overflow-hidden rounded-3xl ${cat.bg} ${cat.gridClass}`}
          >
